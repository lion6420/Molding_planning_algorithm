...
dateNow_list = ['2020', '07', '27']
dateAfter_list = ['2020', '07', '28']
...
week_plan_input_time = order_start_time = datetime.datetime.strptime((dateNow_list[0] + '-' + dateNow_list[1] + '-' + dateNow_list[2] + ' 00:00:00'), '%Y-%m-%d %H:%M:%S')
...
prep = preprocessing(path_basic, week_plan_input_time) # 週計畫初始化
weekly_order = prep.get_planning_input() # 週計畫ReadyQueue
